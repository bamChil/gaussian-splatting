...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, invdepths, output_T = _C.rasterize_gaussians(*args)
        ...
        return color, radii, invdepths, output_T
    ...
    def backward(ctx, grad_out_color, _1, grad_out_depth, _2):
        ...
        args = (raster_settings.image_channel,
                raster_settings.bg,
                means3D, 
                radii, 
                colors_precomp, 
